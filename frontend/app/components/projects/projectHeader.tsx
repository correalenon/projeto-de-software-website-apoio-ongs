    ...
    return (
        <div className="bg-white rounded-lg shadow mb-6">
            ...
            <div className="pt-20">
                ...
                <div>
                    <h1 className="text-2xl font-bold">{project?.name || "Carregando..."}</h1>
                    <p className="text-lg">{project?.ong.name || "Carregando..."}</p>
                    <p className="text-sm text-gray-500 mt-1">Responsável: {project?.ong.name || "Carregando..."}</p>
                ...
                <div className="space-y-3">
                    ...
                    <div className="p-3">
                        ...
                        <div>
                            <h4 className="font-medium text-sm">{project?.ong.name || "Carregando..."}</h4>
                            <p className="text-xs text-gray-500">ONG Responsável</p>
                        </div>
                        </div>
                    </div>
                    </div>
